const contents = [
  { id: 'Highlights',  label: 'Highlights',  desc: 'School Project, notable mentions, moments & milestones' },
  { id: 'SpinOffs',     label: 'SpinOffs',     desc: 'What the different subgroups have been up to' },
